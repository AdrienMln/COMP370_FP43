...
CATEGORY_TOP_WORDS_PATH = 'top10_words_by_category.json'
...
def main():
    ...
    articles_by_coding = fixed_df.groupby(by=['Coding'])
    for coding, group in articles_by_coding:
        ...
        top_words[coding[0]] = [word for word, _ in top_words_group]
